...
DROP DATABASE IF EXISTS husmanskors;
--
-- Name: husmanskors; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE husmanskors WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_Sweden.1252';


ALTER DATABASE husmanskors OWNER TO postgres;
...
--
-- Name: swedish_dict; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.swedish_dict (
    word text NOT NULL
);


ALTER TABLE public.swedish_dict OWNER TO postgres;

--
-- Data for Name: swedish_dict; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.swedish_dict (word) FROM stdin;
Aalto
AB
abakus
abalienation
...
--
-- Name: swedish_dict swedish_dict_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.swedish_dict
    ADD CONSTRAINT swedish_dict_pk PRIMARY KEY (word);
